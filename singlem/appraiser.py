...
class Appraiser:
    ...
    def _appraise_inexactly(self, metagenome_otu_table_collection,
        ...
        querier = Querier()
        queries = querier.query_with_queries(metagenome_collection, sdb_tmp, max_divergence, SMAFA_NAIVE_INDEX_FORMAT, SequenceDatabase.NUCLEOTIDE_TYPE, 1, None, True, None, threads)
